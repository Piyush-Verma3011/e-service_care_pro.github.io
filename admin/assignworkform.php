...
<div class="col-sm-5 mt-5 jumbotron">
    <form action="#" method="POST" class="border p-3">
        ...
        <div class="form-group">
            <label for="request_id">Name</label>
        ...
        <div class="row">
             ...
             <div class="row">
                ...
                <div class="form-group col-md-2 mb-3">
                    ...
                    <input type="text" class="form-control" id="requesterzip" name="requesterzip" onkeypress="isInputNumber(event)"  value="<?php if(isset($row['requester_zip']))echo $row['requester_zip'];?>">
                </div>
             </div>
             <div class="row">
             <div class="form-group col-md-6 mb-3">
                    <label for="requestermail">Email</label>
                    <input type="email" class="form-control" id="requestermail" name="requesteremail"  value="<?php if(isset($row['requester_email']))echo $row['requester_email'];?>">
                </div>
                <div class="form-group col-md-4 mb-3">
                    <label for="requestermobile">Mobile</label>
                    <input type="text" class="form-control" id="requestermobile" name="requestermobile" onkeypress="isInputNumber(event)"  value="<?php if(isset($row['requester_mobile']))echo $row['requester_mobile'];?>">
                </div>
             </div>
             <div class="row">
             <div class="form-group col-md-6 mb-3">
             ...
             <button type="submit" class="btn btn-success me-3" name="assign">Assign</button>
             <button type="submit" class="btn btn-secondary" name="assign">reset</button>
               </div>
